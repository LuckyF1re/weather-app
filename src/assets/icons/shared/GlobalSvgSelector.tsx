...
type GlobalSvgSelectorType = {
    id: string
}

export const GlobalSvgSelector = (props: GlobalSvgSelectorType ) => {
    ...
    switch (id) {
        ...
        case 'close':
            return (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><title>Close-circle-1-light SVG Icon</title><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><circle cx="12" cy="12" r="9"/><path d="m14 10l-4 4m0-4l4 4"/></g></svg>
            )

        case 'Snow':
            return (
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#9FC7FF"
                     className="bi bi-cloud-snow" viewBox="0 0 16 16">
                    <path
